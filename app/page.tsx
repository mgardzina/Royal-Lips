      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8 mb-6">
          <p className="text-[#5a5550] leading-relaxed">
            Przed zabiegiem została przeprowadzona ze mną rozmowa, w której
            osoba przeprowadzająca zabieg poinformowała mnie wyczerpująco o
            wszelkich okolicznościach zabiegu, jego celu, sposobu jego
            przeprowadzenia, przeciwwskazaniach, ryzykach powikłania oraz
            udzieliła mi informacji co do wymaganego zachowania po zabiegu.
          </p>
          <p className="text-[#5a5550] leading-relaxed mt-4">
            <strong>
              Ustalono, iż celem zabiegu jest zastosowanie wypełnienia
              preparatem kwasu hialuronowego.
            </strong>
          </p>
          <p className="text-[#5a5550] leading-relaxed mt-4 text-sm italic">
            Poinformowano mnie, że efekty zabiegu uzależnione są od wielu
            czynników, w tym od biochemii i rodzaju skóry, miejsca iniekcji,
            wstrzykniętej ilości preparatu oraz techniki iniekcji, wobec czego
            nie da się w pełni zagwarantować oczekiwanych wyników zabiegu, ani
            że będą one identyczne w przypadku każdego klienta. Ilość zabiegów
            oraz ich efekt jest uwarunkowany dla każdej osoby indywidualnie.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <p className="text-sm text-[#6b6560] mt-6 leading-relaxed">
              Zabieg z użyciem kwasu hialuronowego polega na wprowadzenie
              poprzez iniekcje odpowiedniej ilości preparatu w celu uzyskania
              odpowiedniego efektu estetycznego np. wygładzenie zmarszczek,
          ...
          <section className="bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <div className="space-y-3">
              {(
                Object.keys(contraindicationLabels) as Array<
                  keyof typeof contraindicationLabels
                >
              ).map((key, index) => (
                <div
                  key={key}
            ...
            {expandedSections.reakcje && (
              <div className="px-6 md:px-8 pb-8">
                ...
                <ul className="space-y-2 text-[#5a5550] text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    zaczerwienienie i/lub zasinienie okolicy pozabiegowej
                    utrzymujące się do tygodnia
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    wylewy, krwiaki, siniaki okolicy pozabiegowej utrzymujące
                    się do 2 tygodni
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    tkliwość tkanek objętych zabiegiem utrzymująca się do około
                    miesiąca
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    możliwe wyczuwanie materiału zabiegowego (grudki) przez
                    okres do 2 tygodni
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
          ...
          <section className="bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden">
            ...
            {expandedSections.powiklania && (
              <div className="px-6 md:px-8 pb-8">
                <p className="text-sm text-[#6b6560] mb-4">
                  Zostałem/am poinformowany/a o możliwości wystąpienia powikłań
                  po zabiegu w postaci:
                </p>

                <div className="mb-6">
                  <h4 className="text-[#8b7355] font-medium mb-3">
            ...
            {expandedSections.zalecenia && (
              <div className="px-6 md:px-8 pb-8">
                ...
                <ul className="space-y-2 text-[#5a5550] text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Stosowanie preparatu pozabiegowego:{" "}
                    <strong>MAŚĆ ARNIKOWA</strong>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Miejsce poddane zabiegowi traktować ze szczególną
                    ostrożnością
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Zachować wysoką higienę dłoni, istnieje bowiem duże ryzyko
                    wtórnego zakażenia
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Nie przemywać mydłem i środkami złuszczającymi miejsc
                    poddanych wypełnieniu przez min. 2 tygodni
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Unikać silnej ekspozycji słonecznej przez 6 tygodni i
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Nie korzystać z sauny, basenu czy krioterapii przez okres 1
                    tygodnia
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Unikać gorących napojów w dniu zabiegu (dotyczy modelowania
                    ust)
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Unikać spania przez kilka dni w pozycji mogącej spowodować
                    uciśnięcie miejsca podania kwasu hialuronowego
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#8b7355]">•</span>
                    Nie poddawać się zabiegom peelingu chemicznego i
                    mechanicznego przez okres 2 tygodni od zabiegu
                  </li>
                </ul>
                ...
                <div className="mt-6 p-4 bg-amber-50 rounded-xl border border-amber-200">
                  ...
                  <p className="text-amber-700 text-sm mt-2">
                    Stosować się ściśle do zaleceń pozabiegowych. Przez 4 doby
                    po zabiegu należy pić dużo wody, minimum 2,5 litra dziennie.
                  </p>
                  <p className="text-amber-700 text-sm mt-2">
                    Utrzymywanie się reakcji zapalnych przez okres dłuższy niż 7
                    dni lub wystąpienie jakichkolwiek reakcji niepożądanych
          ...
          <section className="bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <div className="bg-[#f8f6f3] p-6 rounded-xl mb-6">
              <p className="text-[#5a5550] leading-relaxed">
                ...
                zabiegowi. Treść tego dokumentu była ze mną szczegółowo omówiona
                przed zabiegiem. Miałem/am możliwość zadawania pytań i
                uzyskałem/am wyczerpujące odpowiedzi. Procedury zabiegu zostały
                mi przedstawione w sposób przystępny.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-white/50 rounded-xl">
                <label className="flex items-start gap-4 cursor-pointer">
                  ...
                  <span className="text-sm text-[#5a5550] leading-relaxed">
                    ...
                    Studio Makijażu Permanentnego Royal Lips Joanna Wielgos, ul.
                    Pużaka 37, 38-400 Krosno, NIP: 6842237473 w celu realizacji
              ...
              <div className="p-4 bg-white/50 rounded-xl">
                <label className="flex items-start gap-4 cursor-pointer">
                  ...
                  <span className="text-sm text-[#5a5550] leading-relaxed">
                    Wyrażam zgodę na przetwarzanie moich danych osobowych, przez
                    Studio Makijażu Permanentnego Royal Lips Joanna Wielgos, ul.
                    Pużaka 37, 38-400 Krosno, NIP: 6842237473 w celach
                    marketingowych. Zgodę wyrażam w sposób świadomy i
              ...
              <div className="p-4 bg-white/50 rounded-xl">
                <label className="flex items-start gap-4 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-[#5a5550] leading-relaxed">
                    Wyrażam zgodę na wykonanie fotografii ciała w celu
                    dokumentacji oraz oceny efektywności zabiegu i wyrażam zgodę
                    na umieszczenie fotografii.
                  </span>
                </label>
                  ...
                  <div className="mt-4 ml-9 space-y-4">
                    <div>
                      <label className="block text-sm text-[#6b6560] mb-2">
                        Miejsca publikacji fotografii (np. www, Facebook,
                        Instagram itd.)
                      </label>
                      <input
                        type="text"
            ...
            {expandedSections.rodo && (
              <div className="px-6 md:px-8 pb-8 text-sm text-[#5a5550] space-y-4">
                <p>
                  ...
                  rozporządzenie o ochronie danych) (dalej „RODO") informuję,
                  że:
                </p>

                <div className="space-y-3">
                  <p>
                    <strong>I.</strong> Administratorem Pani/Pana danych
                    osobowych jest <strong>Joanna Wielgos</strong>, prowadząca
                    działalność gospodarczą pod nazwą:{" "}
                    <strong>Royal Lips Studio Makijażu Permanentnego</strong>,
                    ul. Pużaka 37, 38-400 Krosno, REGON 180685260, NIP
                    6842237473
                  </p>

                  <p>
                    <strong>II.</strong> Będę przetwarzać Pani/Pana dane
                    wyłącznie w celu wykonania umowy o wykonanie zabiegu
                    kosmetycznego, w zakresie wynikającym ze zlecenia, i objętej
                    zgodą na podstawie Oświadczenia o wyrażeniu zgody na
                    wykonanie zabiegu kosmetycznego, zgodnie z zasadami
                    wymienionymi w art. 5. Niedopuszczalne jest przetwarzanie
                    Pani/Pana danych w celu marketingu bezpośredniego.
                  </p>

                  <p>
                    <strong>III. Prawo do sprzeciwu</strong>
                    <br />W każdej chwili przysługuje Pani/Panu prawo do
                    wniesienia sprzeciwu wobec przetwarzania Pani/Pana danych,
                    przetwarzanych w celu i na podstawie wskazanych powyżej.
                    Przestaniemy przetwarzać Pani/Pana dane w tych celach, chyba
                    że będziemy w stanie wykazać, że istnieją ważne, prawnie
                    uzasadnione podstawy, które są nadrzędne wobec Pani/Pana
                    interesów, praw i wolności lub Pani/Pana dane będą nam
                    niezbędne do ewentualnego ustalenia, dochodzenia lub obrony
                    roszczeń.
                  </p>

                  <p>
                    <strong>IV.</strong> Będę przechowywać dane przez okres
                    niezbędny dla prawidłowego wykonania umowy, nie dłużej
                    jednak niż do przedawnienia dochodzenia roszczenia lub
                    zgłoszenia szkody.
                  </p>

                  <p>
                    <strong>V.</strong> Pani/Pana dane osobowe mogą zostać
                    przekazywane wyłącznie pracownikom księgowości/biura
                    rachunkowego, na których przepisy nakładają obowiązek
                    zachowania tajemnicy – tylko w celu umożliwienia rozliczenia
                    wykonanego zabiegu, wystawienia faktury, rachunku imiennego,
                    lub pracownikom przedsiębiorstwa Joanna Wielgos Royal Lips
                    Studio Makijażu Permanentnego. (ul. Pużaka 37, 38-400
                    Krosno), którym powierzono pisemnie przetwarzanie danych
                    osobowych i którzy ponoszą odpowiedzialność za naruszenie
                    zasad przetwarzania.
                  </p>
                  ...
                  <ul className="list-disc ml-6 space-y-1">
                    ...
                    <li>
                      żądania usunięcia, ograniczenia lub wniesienia sprzeciwu
                  ...
                  <p>
                    <strong>VII.</strong> Podanie danych jest dobrowolne z tym,
                    że odmowa ich podania może uniemożliwić wykonanie zabiegu w
                    ramach usług oferowanych Klientom, i stanowi podstawę odmowy
                    ich wykonania.
                  </p>

                  <p>
                    <strong>VIII.</strong> Informuję, że nie podejmuję decyzji w
                    sposób zautomatyzowany i Pani/Pana dane nie są profilowane.
                  </p>

                  <p>
                    <strong>IX.</strong> W każdej chwili przysługuje Pani/Panu
                    prawo do wycofania zgody na przetwarzanie Pani/Pana danych
                    osobowych (w tym należących do szczególnej kategorii), ale
                    cofnięcie zgody nie wpływa na zgodność z prawem
                    przetwarzania, którego dokonano zgodnie z prawem, przed jej
                    wycofaniem.
                  </p>
                </div>
                ...
                <div className="mt-6 p-4 bg-[#f8f6f3] rounded-xl">
                  <p className="text-[#5a5550]">
                    Wyrażam zgodę na przetwarzanie moich danych osobowych, przez
                    Royal Lips Studio Makijażu Permanentnego Joanna Wielgos w
                    celu udzielenia mi pomocy prawnej.
                  </p>
                </div>
