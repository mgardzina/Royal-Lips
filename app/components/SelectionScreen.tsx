import { Syringe, PenTool, Zap, Sparkles, Eraser } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="w-20 h-20 bg-[#efe9e1] rounded-full flex items-center justify-center group-hover:bg-[#8b7355]/10 transition-colors">
              <svg
                ...
                className="w-12 h-12 text-[#8b7355] group-hover:scale-110 transition-transform duration-300"
                fill="currentColor"
              >
                <path
                  d="M420.792,140.277c-22.891-24.035-53.77-37.81-86.947-38.787c-28.264-0.833-55.419,7.711-77.845,24.265
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#8b8580]">Zabieg makijażowy</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#8b8580]">Zabieg liftingowy</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#8b8580]">kwas polimlekowy, osocze</p>
            </div>
          </button>
          ...
          >
            <div className="w-20 h-20 bg-[#efe9e1] rounded-full flex items-center justify-center group-hover:bg-[#8b7355]/10 transition-colors">
              <Eraser className="w-10 h-10 text-[#8b7355] group-hover:scale-110 transition-transform duration-300" />
            </div>
            <div className="text-center">
              <h3 className="text-xl font-serif text-[#4a4540] mb-2 font-medium">
                Usuwanie Tatuażu / Makijażu
              </h3>
              <p className="text-sm text-[#8b8580]">Laser pikosekundowy</p>
            </div>
          </button>
        </div>
